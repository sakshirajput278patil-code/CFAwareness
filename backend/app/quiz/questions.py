...
QUIZ_QUESTIONS = [
    ...
    QuizQuestion(
        ...
        options=["National rail train", "Domestic short-haul flight", "Average petrol car with 4 passengers", "Local bus"],
        correct_option_index=1,
    ...
    QuizQuestion(
        ...
        options=["Recycling all plastics", "Washing clothes in cold water", "Living car-free", "Upgrading lightbulbs to LEDs"],
        correct_option_index=2,
    ...
    QuizQuestion(
        ...
        options=["It is about the same", "It is 10% lower", "It is 30% lower", "It is over 50% lower"],
    ...
    QuizQuestion(
        ...
        options=["Carbon absorbed by trees", "Emissions from breathing", "Emissions generated during manufacturing and transport of goods", "Carbon stored in fossil fuels"],
        correct_option_index=2,
